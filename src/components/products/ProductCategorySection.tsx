        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2 text-xs">
            <a
              ...
              className="inline-flex items-center gap-1.5 rounded-full border border-blue-700/15 bg-white px-3 py-1.5 font-semibold text-blue-700 hover:bg-blue-700/5"
            >
