  ...
  return (
    <div className="space-y-6 sm:space-y-8">
          ...
          <label className="block">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full h-10 pl-12 pr-4 rounded-lg border border-gray-300 text-base focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent"
              />
            </div>
          </label>
        </div>
        ...
        <div className="space-y-3">
          <label className="block">
            ...
            <input
              ...
              min="1"
              step="1"
              className="w-full h-10 px-4 rounded-lg border border-gray-300 text-base focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent"
              style={{
                WebkitAppearance: "none",
                MozAppearance: "textfield",
                WebkitUserSelect: "text",
      ...
      <button
        ...
        disabled={isLoading}
        className="w-full bg-peach text-blue-700 font-semibold hover:brightness-95 active:brightness-90 py-6 text-base rounded-lg border-none cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center justify-center gap-2"
        style={{
      ...
      {/* Info Box */}
      <div className="bg-blue-700/5 rounded-lg p-4 border border-blue-700/10">
