        ...
        <Container>
          <div className="flex h-16 items-center justify-between sm:h-20">
            ...
            >
              ...
              <span className="text-[19px] font-extrabold tracking-tight text-blue-700 leading-none sm:text-xl">
                ABZ Capital
              </span>
            </Link>
              ...
              {NAV.map((item) => {
                ...
                return (
                  <Link
                    ...
                    href={item.href}
                    className={cn(
                      "relative text-sm font-medium text-ink/80 transition hover:text-blue-700",
            ...
            <div className="hidden lg:flex">
              <Link
                ...
                className="inline-flex items-center justify-center rounded-lg bg-blue-700 px-4 py-2.5 text-sm font-semibold text-white shadow-button transition hover:brightness-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-700/30"
              >
