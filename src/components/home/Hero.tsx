  ...
  return (
    <section className="relative overflow-hidden bg-white pt-16 pb-20 sm:pt-24 sm:pb-28 lg:pt-28 lg:pb-32">
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute right-[-12%] top-[-10%] h-[480px] w-[480px] rounded-full bg-blue-700/15 blur-3xl" />
      ...
      <Container>
        <div className="grid items-center gap-12 lg:grid-cols-12">
          <div className="lg:col-span-7">
            <span className="inline-flex items-center gap-2 rounded-full border border-blue-700/15 bg-white/70 px-3 py-1.5 text-xs font-semibold text-blue-700 backdrop-blur">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <Link
                href="/products"
                className="inline-flex items-center gap-2 rounded-xl bg-blue-700 px-6 py-3.5 text-sm font-semibold text-white shadow-button transition hover:brightness-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-700/40"
              >
                Explore products
              ...
              <Link
                href="/fundraise"
                className="inline-flex items-center gap-2 rounded-xl border border-blue-700/20 bg-white px-6 py-3.5 text-sm font-semibold text-blue-700 transition hover:bg-blue-700/5"
              >
                Apply for funding
              </Link>
            </div>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-2">
              {CHIPS.map((chip) => (
                <Link
                  key={chip.href}
                  href={chip.href}
                  className="rounded-full border border-blue-700/15 bg-white/85 px-3.5 py-1.5 text-xs font-semibold text-blue-700 backdrop-blur transition hover:bg-blue-700 hover:text-white"
                >
                  {chip.label}
                </Link>
              ))}
...
function HeroVisual() {
  return (
    <div className="relative mx-auto aspect-[4/5] w-full max-w-md">
      <div className="absolute inset-0 rounded-3xl bg-blue-700 shadow-elev" />
      ...
      <div className="absolute bottom-10 left-[-18px] w-[72%] rounded-2xl bg-white p-4 shadow-elev">
        <div className="flex items-center gap-3">
          <div className="flex size-10 items-center justify-center rounded-lg bg-peach text-blue-700">
        ...
        <div className="mt-3 h-1.5 w-full overflow-hidden rounded-full bg-blue-700/10">
