        ...
        <div className="rounded-3xl bg-white shadow-2xl overflow-hidden">
          ...
          <div className="p-6 sm:p-8 space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-lg font-bold text-indigo">+{SAMPLE_LOAN.returnPerMonth}</p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-sm font-bold text-indigo">Your Total Return</span>
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-4">
              <button
                type="button"
                className="flex-1 rounded-xl bg-indigo px-6 py-4 text-sm font-bold text-white shadow-button transition hover:brightness-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo/40 cursor-pointer active:scale-95"
              ...
              <button
                onClick={onClose}
                type="button"
                className="flex-1 rounded-xl border-2 border-indigo bg-transparent px-6 py-4 text-sm font-bold text-indigo transition hover:bg-indigo/5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo/40 cursor-pointer"
              >
                Close
              </button>
            </div>
