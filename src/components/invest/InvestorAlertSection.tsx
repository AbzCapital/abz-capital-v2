            ...
            <div className="rounded-3xl bg-white shadow-2xl overflow-hidden">
              ...
              <div className="p-6 sm:p-8 space-y-8">
                ...
                <div className="flex flex-col sm:flex-row gap-3 pt-4">
                  <button type="button" className="flex-1 rounded-xl bg-indigo px-6 py-3.5 text-sm font-bold text-white shadow-button transition hover:brightness-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo/40 flex items-center justify-center gap-2 cursor-pointer">
                    Fund This Loan
                    <ArrowRight className="size-4" />
                  </button>
                  <button type="button" onClick={onClose} className="flex-1 rounded-xl border-2 border-indigo bg-transparent px-6 py-3.5 text-sm font-bold text-indigo transition hover:bg-indigo/5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo/40 cursor-pointer">
                    Close
                  </button>
                </div>
              </div>
