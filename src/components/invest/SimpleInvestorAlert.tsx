  ...
  return (
    <div>
      ...
      {showAlert && (
        <div className="mb-12">
          <Container>
            <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-lg p-6 sm:p-8 border border-indigo/20">
              {/* Header */}
              <div className="mb-6 pb-4 border-b border-indigo/10">
              ...
              {/* Returns */}
              <div className="bg-indigo/5 rounded-xl p-4 mb-6 border border-indigo/10">
                <p className="text-sm text-muted-ink mb-2">Monthly Return</p>
                <p className="text-2xl font-bold text-indigo">{SAMPLE_LOAN.monthlyPayment}</p>
                <p className="text-xs text-muted-ink mt-1">3% of {SAMPLE_LOAN.loanAmount} per month</p>
              </div>

              {/* CTA */}
              <button className="w-full bg-indigo text-white font-bold py-3 rounded-xl hover:brightness-110 transition cursor-pointer">
                Fund This Loan
              </button>
            </div>
          </Container>
