            ...
            return (
              ...
              >
                ...
                <div className="relative h-48 sm:h-56 bg-gray-200 overflow-hidden">
                  ...
                  />
                  {/* Icon Badge */}
                  <div className="absolute top-4 right-4 rounded-lg bg-indigo p-3 shadow-lg">
                ...
                <div className="p-6 sm:p-8">
                  ...
                  <ul className="space-y-2 mb-6">
                    {opp.items.map((item, itemIdx) => (
                      <li key={itemIdx} className="flex items-start gap-3">
                        <Check className="size-4 text-indigo shrink-0 mt-1" />
                  ...
                  {/* CTA Button */}
                  <button className="w-full rounded-xl bg-indigo/10 hover:bg-indigo/20 px-4 py-2 text-sm font-bold text-indigo transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo/40">
                    Learn More
                  </button>
                </div>
              </div>
