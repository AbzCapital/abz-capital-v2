...
interface HeroWithMetricsProps {
  onOpenModal: () => void;
}

export function HeroWithMetrics({ onOpenModal }: HeroWithMetricsProps) {
  return (
    <section className="relative min-h-screen overflow-hidden bg-gradient-to-r from-indigo via-indigo to-indigo/90">
