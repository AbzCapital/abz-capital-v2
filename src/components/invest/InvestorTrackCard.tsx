    ...
    >
      <div
        ...
        className={cn(
          ...
          variant === "indigo" ? "bg-peach/30" : "bg-blue-700/20"
        )}
      />
      ...
      <span
        className={cn(
          ...
          variant === "indigo" ? "bg-peach text-blue-700" : "bg-blue-700 text-white"
        )}
      >
      ...
      <span
        className={cn(
          ...
          variant === "indigo" ? "text-peach" : "text-blue-700"
        )}
      >
        {label}
      </span>
      ...
      <Link
        ...
        className={cn(
          ...
          variant === "indigo"
            ? "bg-peach text-blue-700 hover:brightness-105"
            : "bg-blue-700 text-white hover:brightness-110"
        )}
      >
        Register interest
