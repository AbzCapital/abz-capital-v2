      ...
      <Container>
        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div className="rounded-2xl bg-white p-8 shadow-card hover:shadow-lg transition">
            <div className="rounded-lg bg-indigo/10 p-4 w-fit mb-6">
              <Shield className="size-6 text-indigo" />
            </div>
          ...
          <div className="rounded-2xl bg-white p-8 shadow-card hover:shadow-lg transition">
            <div className="rounded-lg bg-indigo/10 p-4 w-fit mb-6">
              <Target className="size-6 text-indigo" />
            </div>
          ...
          <div className="rounded-2xl bg-white p-8 shadow-card hover:shadow-lg transition">
            <div className="rounded-lg bg-indigo/10 p-4 w-fit mb-6">
              <BarChart3 className="size-6 text-indigo" />
            </div>
        ...
        <div className="mt-16 rounded-2xl bg-white p-8 sm:p-10 border border-indigo/10">
          ...
          <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-4 text-center text-sm">
            <div>
              <p className="font-bold text-indigo text-2xl mb-1">100%</p>
              <p className="text-muted-ink text-xs">Secured Loans</p>
            </div>
            <div>
              <p className="font-bold text-indigo text-2xl mb-1">Humane</p>
              <p className="text-muted-ink text-xs">Lending Practices</p>
            </div>
            <div>
              <p className="font-bold text-indigo text-2xl mb-1">Transparent</p>
              <p className="text-muted-ink text-xs">Real Data</p>
            </div>
            <div>
              <p className="font-bold text-indigo text-2xl mb-1">Protected</p>
