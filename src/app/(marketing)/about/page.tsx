...
export default function AboutPage() {
  return (
    <>
        ...
        <Container>
          <div className="grid items-center gap-12 lg:grid-cols-12">
            ...
            <div className="lg:col-span-5">
              <div className="relative aspect-square overflow-hidden rounded-3xl bg-blue-700 p-8 text-white shadow-elev">
        ...
        <Container>
          <div className="grid gap-10 lg:grid-cols-2">
            <div className="rounded-3xl border border-line bg-white p-8 shadow-card sm:p-10">
              <span className="inline-flex size-12 items-center justify-center rounded-xl bg-blue-700 text-white">
            ...
            <div className="rounded-3xl border border-line bg-white p-8 shadow-card sm:p-10">
              <span className="inline-flex size-12 items-center justify-center rounded-xl bg-peach text-blue-700">
      ...
      <Section spacing="lg" background="mesh-soft">
        <Container>
          <div className="mx-auto max-w-2xl text-center">
            <span className="text-xs font-semibold uppercase tracking-widest text-blue-700">Our values</span>
          ...
          <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-5">
            {VALUES.map((v) => (
              <div
                key={v.label}
                className="rounded-2xl border border-line bg-white p-6 text-left shadow-card transition hover:-translate-y-1 hover:border-blue-700/20"
              >
                <span className="inline-flex size-10 items-center justify-center rounded-lg bg-blue-700/5 text-blue-700">
      ...
      <Section spacing="lg" background="white">
        <Container>
          <div className="overflow-hidden rounded-3xl bg-blue-700 p-10 text-white sm:p-14">
            <div className="grid items-center gap-8 lg:grid-cols-3">
              ...
              <div className="flex flex-wrap items-center gap-3 lg:justify-end">
                <Link
                  href="/contact"
                  className="inline-flex items-center gap-2 rounded-xl bg-peach px-6 py-3 text-sm font-bold text-blue-700 transition hover:brightness-105"
                >
                  Talk to us
