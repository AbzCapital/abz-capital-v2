...
import { FundingOpportunityFormHTML } from "@/components/fundraise/FundingOpportunityFormHTML";
    ...
    return (
      <div className="min-h-screen bg-green-50 p-6 flex items-center justify-center">
        <div className="text-center max-w-md bg-white rounded-2xl shadow-lg p-8">
          ...
          <a
            href="/fundraise"
            className="inline-block px-6 py-3 bg-blue-700 text-white font-bold rounded-lg hover:bg-blue-700/90 transition"
          >
            Submit Another
          </a>
        </div>
          ...
          <div className="grid gap-10 lg:grid-cols-12">
            <div className="lg:col-span-5">
              <div className="rounded-3xl border border-line bg-white p-6 shadow-card sm:p-8">
                <span className="inline-flex size-11 items-center justify-center rounded-xl bg-blue-700 text-white">
                ...
                <div className="mt-6 flex flex-col gap-3">
                  <a
                    ...
                    className="inline-block w-full rounded-xl bg-blue-700 px-6 py-3 text-center font-bold text-white transition hover:bg-blue-700/90"
                  >
                    Schedule a meeting
                  </a>
              ...
              <div className="mt-5 rounded-3xl border border-line bg-white p-6 shadow-card sm:p-8">
                <span className="inline-flex size-11 items-center justify-center rounded-xl bg-peach text-blue-700">
