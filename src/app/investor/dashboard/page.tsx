      ...
      <header className="border-b border-line bg-white shadow-sm sticky top-0">
        <Container>
          <div className="flex justify-between items-center h-16">
            <div>
              <h1 className="text-xl font-extrabold text-blue-700">ABZ Investor</h1>
            ...
            <div className="flex gap-2">
              {!investor?.kycStatus || investor.kycStatus === "pending" ? (
                <Link href="/investor/kyc">
                  <Button className="bg-peach text-blue-700">
        ...
        <Container>
          <div className="grid gap-6 md:grid-cols-3 mb-8">
            ...
            <Card className="p-6">
              ...
              <p className="text-2xl font-extrabold text-blue-700">{deals.length}</p>
            </Card>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <Card className="md:col-span-2 p-6">
              ...
              {deals.length === 0 ? (
                ...
                <div className="space-y-2 text-sm">
                  {deals.map((deal: any) => (
                    <div key={deal.id} className="p-2 bg-blue-700/5 rounded">
